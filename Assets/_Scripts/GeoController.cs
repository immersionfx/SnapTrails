...
namespace Google.XR.ARCoreExtensions.Samples.Geospatial
{
    ...
    public class GeoController : MonoBehaviour
    {
        ...
        /// </summary>
        private const string _localizingMessage = "Localizing your device....";
        ...
        {
            Debug.Log("@@@ SwitchToARView: " + enable);
            _isInARView = enable;
            ...
            {
                _asyncCheck = AvailabilityCheck(); //Permission.Camera
        ...
        public void Update()
        {
            ...
            if (_enablingGeospatial)
            {
                ...
                {
                    DebugText.text = "!_configurePrepareTime";
                    return;
                }
            }
